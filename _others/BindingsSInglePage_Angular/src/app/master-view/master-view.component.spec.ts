...
describe('MasterViewComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, HttpClientTestingModule, IgxGridModule, IgxButtonModule, IgxRippleModule, IgxCardModule, IgxIconModule, IgxSelectModule ]
    })
    .compileComponents();
  });
