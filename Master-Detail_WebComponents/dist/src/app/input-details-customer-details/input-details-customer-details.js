...
let InputDetailsCustomerDetails = class InputDetailsCustomerDetails extends LitElement {
    constructor() {
        super();
...
InputDetailsCustomerDetails.styles = css `
    :host {
      height: 100%;
      display: flex;
...
export default InputDetailsCustomerDetails;
//# sourceMappingURL=input-details-customer-details.js.map