...
let ListDetails = class ListDetails extends LitElement {
    ...
    render() {
        ...
        <div slot="subtitle">${(_a = customer.customerID) !== null && _a !== void 0 ? _a : 'AROUT'}</div>
      </igc-list-item>`);
            }
        }
        return html `
      ...
      <div class="column-layout group">
        ...
        <div class="row-layout group_2">
          <div class="column-layout group_3">
            ...
            <p class="typography__body-2 text_1">
            ${(_h = this.selectedCustomer) === null || _h === void 0 ? void 0 : _h.phone}
            </p>
          </div>
          <div class="column-layout group_4">
            <p class="typography__subtitle-2 text_1">
        ...
        <div class="column-layout group_6">
          <igc-grid row-selection="Single" @rowSelectionChanging=${this.onSelectOrder} .data="${this.northwindCloudAppOrder}" primary-key="employeeID" display-density="cosy" allow-filtering="true" filter-mode="excelStyleFilter" auto-generate="false" width="709px" class="ig-typography ig-scrollbar grid">
            <igc-grid-toolbar>
          ...
          <igc-grid .data="${!this.orderDetails ? [] : [this.orderDetails]}" primary-key="orderID" display-density="cosy" allow-filtering="true" filter-mode="excelStyleFilter" auto-generate="false" width="707px" class="ig-typography ig-scrollbar grid_1">
            <igc-grid-toolbar>
